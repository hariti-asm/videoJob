                ...
                <div class="card-body">
                        <form action="{{ route('profile.create') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ Auth::user()->address }}">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="number" class="form-control{{ $errors->has('experience') ? ' is-invalid' : '' }}" name="experience" value="{{ Auth::user()->experience }}">
                            ...
                            <div class="form-group mt-3">
                                <label for="">Bio</label>
                                <textarea name="bio" id="" style="height: 120px" class="form-control{{ $errors->has('bio') ? ' is-invalid' : '' }}" cols="30" rows="10">{{ Auth::user()->bio }}</textarea>
                                @if ($errors->has('bio'))
                                <div style="color:red">
            ...
            <div class="col-md-4">
                <form action="{{ route('avatar') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <img src="{{ url('/storage/avatars/'. Auth::user()->avatar )}}" style="width:100px; height:100px;border-radius:100px;object-fit: cover; margin:0px auto" class="border  mb-3" alt="">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <p> <strong class="badge bg-secondary badge-primary">Experience:</strong> {{ Auth::user()->experience }} </p>
